...
// This file contains custom SVG icons to replace lucide-react
...
export const RefreshCwIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const WandIcon = ({ className = "", size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M8 9h2"></path>
    <path d="M20 9h2"></path>
    <path d="M17.7 11.7l1.4-1.4"></path>
    <path d="M17.7 6.3l1.4 1.4"></path>
    <path d="M12.2 12l5.1 5.1a2.8 2.8 0 1 1-4 4L8.2 16z"></path>
  </svg>
);
