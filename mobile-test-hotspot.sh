...
# Script to start the backend and frontend for mobile testing with hotspot
...
# Start the backend and frontend with the mobile environment
echo -e "\nStarting servers..."
NODE_ENV=development DOTENV_CONFIG_PATH=.env.mobile npm run all
